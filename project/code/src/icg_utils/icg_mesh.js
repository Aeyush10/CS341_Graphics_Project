...
export async function icg_mesh_load_obj_project_version(url, material_colors_by_name) {
	const obj_data = await load_text(url)
	const mesh_loaded_obj = new Mesh(obj_data)
...
export async function icg_mesh_load_obj_into_regl(regl_instance, url, material_colors_by_name) {
	const mesh_cpu = await icg_mesh_load_obj_project_version(url, material_colors_by_name)
